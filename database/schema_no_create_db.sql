...
CREATE TABLE IF NOT EXISTS `eat_analysis` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `page_id` int(11) NOT NULL,
...
-- Adicionar as Foreign Keys apenas depois que todas as tabelas forem criadas
-- (algumas hospedagens têm problemas com FK durante criação)

-- Foreign Keys para a tabela pages
ALTER TABLE `pages` 
ADD CONSTRAINT `fk_pages_analysis` 
FOREIGN KEY (`analysis_id`) REFERENCES `analyses`(`id`) ON DELETE CASCADE;

-- Foreign Keys para a tabela page_content
ALTER TABLE `page_content` 
ADD CONSTRAINT `fk_page_content_page` 
FOREIGN KEY (`page_id`) REFERENCES `pages`(`id`) ON DELETE CASCADE;

-- Foreign Keys para a tabela links
ALTER TABLE `links` 
ADD CONSTRAINT `fk_links_source_page` 
FOREIGN KEY (`source_page_id`) REFERENCES `pages`(`id`) ON DELETE CASCADE;

ALTER TABLE `links` 
ADD CONSTRAINT `fk_links_target_page` 
FOREIGN KEY (`target_page_id`) REFERENCES `pages`(`id`) ON DELETE SET NULL;

-- Foreign Keys para a tabela images
ALTER TABLE `images` 
ADD CONSTRAINT `fk_images_page` 
FOREIGN KEY (`page_id`) REFERENCES `pages`(`id`) ON DELETE CASCADE;

-- Foreign Keys para a tabela structured_data
ALTER TABLE `structured_data` 
ADD CONSTRAINT `fk_structured_data_page` 
FOREIGN KEY (`page_id`) REFERENCES `pages`(`id`) ON DELETE CASCADE;

-- Foreign Keys para a tabela issues
ALTER TABLE `issues` 
ADD CONSTRAINT `fk_issues_analysis` 
FOREIGN KEY (`analysis_id`) REFERENCES `analyses`(`id`) ON DELETE CASCADE;

ALTER TABLE `issues` 
ADD CONSTRAINT `fk_issues_page` 
FOREIGN KEY (`page_id`) REFERENCES `pages`(`id`) ON DELETE CASCADE;

-- Foreign Keys para a tabela robots_analysis
ALTER TABLE `robots_analysis` 
ADD CONSTRAINT `fk_robots_analysis_analysis` 
FOREIGN KEY (`analysis_id`) REFERENCES `analyses`(`id`) ON DELETE CASCADE;

-- Foreign Keys para a tabela sitemap_analysis
ALTER TABLE `sitemap_analysis` 
ADD CONSTRAINT `fk_sitemap_analysis_analysis` 
FOREIGN KEY (`analysis_id`) REFERENCES `analyses`(`id`) ON DELETE CASCADE;

-- Foreign Keys para a tabela performance_metrics
ALTER TABLE `performance_metrics` 
ADD CONSTRAINT `fk_performance_metrics_page` 
FOREIGN KEY (`page_id`) REFERENCES `pages`(`id`) ON DELETE CASCADE;

-- Foreign Keys para a tabela eat_analysis
ALTER TABLE `eat_analysis` 
ADD CONSTRAINT `fk_eat_analysis_page` 
FOREIGN KEY (`page_id`) REFERENCES `pages`(`id`) ON DELETE CASCADE;

-- Foreign Keys para a tabela content_clusters
ALTER TABLE `content_clusters` 
ADD CONSTRAINT `fk_content_clusters_analysis` 
FOREIGN KEY (`analysis_id`) REFERENCES `analyses`(`id`) ON DELETE CASCADE;

-- Foreign Keys para a tabela page_clusters
ALTER TABLE `page_clusters` 
ADD CONSTRAINT `fk_page_clusters_page` 
FOREIGN KEY (`page_id`) REFERENCES `pages`(`id`) ON DELETE CASCADE;

ALTER TABLE `page_clusters` 
ADD CONSTRAINT `fk_page_clusters_cluster` 
FOREIGN KEY (`cluster_id`) REFERENCES `content_clusters`(`id`) ON DELETE CASCADE;

-- Foreign Keys para a tabela analysis_logs
ALTER TABLE `analysis_logs` 
ADD CONSTRAINT `fk_analysis_logs_analysis` 
FOREIGN KEY (`analysis_id`) REFERENCES `analyses`(`id`) ON DELETE CASCADE;
